...
- Вручную на маке посыпалось все - пошел ставить в докер на рабочий проект

- внутри докера обновил все зависимости, скачал убунту версию atheris через `pip install atheris`

- Запустил соот-ий код для проверки эндпоинтов:
```
#!/usr/bin/env python3  
import os, django  
